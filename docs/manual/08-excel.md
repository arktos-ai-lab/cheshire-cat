...
# 8. Using Felix from Excel

In order to use Felix from Microsoft Excel, you must select the Excel interface component during installation. See *Installation* for details.
