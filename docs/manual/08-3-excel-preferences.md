...
# 8.3. Setting Preferences in Excel
...
>
Use translation history: Select whether to use the Translation History feature in Excel. See *Translation History* for details.
